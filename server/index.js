...
io.on('connection', (socket) => {
    ...
    socket.on('chat message', (msg) => {
        const sender = socket.user ? socket.user.username : 'Default sender'; // Provide a default sender if not authenticated
...
const CLIENT_ID = 'fd90e7adbf0d47e7ac7d39a73afe60ab';
const CLIENT_SECRET = '27c5a8222cd84ff19cfce79f59bce1fa';
